...
# verdict = Column(Enum('QU,AC,PE,WA,CE,RE,TL,ML,OL,SE,RF,CJ'.split(','), name='submission_verdict'), default='QU', nullable=False)
...
class Submission(Base):
    ...
    # http://uva.onlinejudge.org/index.php?option=com_content&task=view&id=16&Itemid=31
    # verdict = Column(Enum('QU,AC,PE,WA,CE,RE,TL,ML,OL,SE,RF,CJ'.split(','), name='submission_verdict'), default='QU', nullable=False)
